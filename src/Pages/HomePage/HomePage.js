...
function HomePage(props) {
    return (
        ...
        <h2 className="About">As a software engineer I strongly believe attitude is the core fundemental principal of becoming successful. An attitude of "I can and I will" pushes us to succeed and grow. An attidue of compassion for yourself and others forms connection. An attidue of patience and perserverance produces creativity. Attitude is the foundation of which we can turn impossiblity into possiblity.
        <br />
        <br />
